...
movies_dict = pickle.load(open(r'C:\Users\KIIICK\Documents\Projects\Python\Movies-Recommendor\models\movies_dict.pkl','rb'))
movies = pd.DataFrame(movies_dict)

similarity = pickle.load(open(r'C:\Users\KIIICK\Documents\Projects\Python\Movies-Recommendor\models\similarity.pkl','rb'))
